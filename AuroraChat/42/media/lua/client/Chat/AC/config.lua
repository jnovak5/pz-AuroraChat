...
AC.ChatTypes["whisper"] = {
    name = "Whisper",
    command = {"whisper", "w"},
    xyRange = SandboxVars.AuroraChat.RangeXYWhisper,
    zRange = SandboxVars.AuroraChat.RangeZWhisper,
...
AC.ChatTypes["low"] = {
    ...
    xyRange = SandboxVars.AuroraChat.RangeXYLow,
    zRange = SandboxVars.AuroraChat.RangeZLow,
...
AC.ChatTypes["say"] = {
    name = "Say",
    command = {"say", ""},
    xyRange = SandboxVars.AuroraChat.RangeXYSay,
    zRange = SandboxVars.AuroraChat.RangeZSay,
    questionPrefix = "asks",
...
AC.ChatTypes["loud"] = {
    name = "Loud",
    command = {"loud", "yell", "y"},
    xyRange = SandboxVars.AuroraChat.RangeXYLoud,
    zRange = SandboxVars.AuroraChat.RangeZLoud,
...
AC.ChatTypes["shout"] = {
    name = "Shout",
    command = {"shout", "s"},
    xyRange = SandboxVars.AuroraChat.RangeXYShout,
    zRange = SandboxVars.AuroraChat.RangeZShout,
